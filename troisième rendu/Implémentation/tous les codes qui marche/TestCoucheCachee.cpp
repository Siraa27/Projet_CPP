...
{	
   ...
   C1->foncActivation(*SommePond);	
   CPPUNIT_ASSERT( abs(C2->getNeurone(0).getSortie() -  C1->getNeurone(0).getSortie()) < 0.00001 );
   CPPUNIT_ASSERT( abs( C2->getNeurone(1).getSortie() - C1->getNeurone(1).getSortie() ) < 0.00001); 
	//}*/
